...
checkbox = document.addEventListener('input', e => {
    if (isChecked = e.target.checked) {
        ...
        document.getElementById('link-portfolio-7').classList.add('fa-solid-bright');
        document.getElementById('github-portfolio-7').classList.add('fa-solid-bright');
        ...
        document.getElementById('link-portfolio-7').classList.remove('fa-solid-bright');
        document.getElementById('github-portfolio-7').classList.remove('fa-solid-bright');
