...
checkbox = document.addEventListener('input', e => {
    if (isChecked = e.target.checked) {
        ...
        document.getElementById('logo-portfolio-1').classList.add('fa-solid-bright');
        document.getElementById('card-portfolio-2').classList.add('card-bright');
        document.getElementById('logo-portfolio-2').classList.add('fa-solid-bright');
        document.getElementById('card-portfolio-3').classList.add('card-bright');
        document.getElementById('logo-portfolio-3').classList.add('fa-solid-bright');
        document.getElementById('card-portfolio-4').classList.add('card-bright');
        document.getElementById('logo-portfolio-4').classList.add('fa-solid-bright');
        document.getElementById('card-portfolio-5').classList.add('card-bright');
        document.getElementById('logo-portfolio-5').classList.add('fa-solid-bright');
        document.getElementById('card-portfolio-6').classList.add('card-bright');
        document.getElementById('logo-portfolio-6').classList.add('fa-solid-bright');
        document.getElementById('card-portfolio-7').classList.add('card-bright');
        document.getElementById('logo-portfolio-7').classList.add('fa-solid-bright');
        ...
        document.getElementById('logo-portfolio-1').classList.remove('fa-solid-bright');
        document.getElementById('card-portfolio-2').classList.remove('card-bright');
        document.getElementById('logo-portfolio-2').classList.remove('fa-solid-bright');
        document.getElementById('card-portfolio-3').classList.remove('card-bright');
        document.getElementById('logo-portfolio-3').classList.remove('fa-solid-bright');
        document.getElementById('card-portfolio-4').classList.remove('card-bright');
        document.getElementById('logo-portfolio-4').classList.remove('fa-solid-bright');
        document.getElementById('card-portfolio-5').classList.remove('card-bright');
        document.getElementById('logo-portfolio-5').classList.remove('fa-solid-bright');
        document.getElementById('card-portfolio-6').classList.remove('card-bright');
        document.getElementById('logo-portfolio-6').classList.remove('fa-solid-bright');
        document.getElementById('card-portfolio-7').classList.remove('card-bright');
        document.getElementById('logo-portfolio-7').classList.remove('fa-solid-bright');
